...
### Mappability file
A mappability file in bigWig format must be provided for the given reference genome. These can be obtained from the same organization (for example, [here](https://genome.ucsc.edu/cgi-bin/hgFileUi?db=mm9&g=wgEncodeMapability)). The 100-mers mappability track for both hg38 and hg19 have been provided for download at this [Google Drive](https://drive.google.com/drive/folders/1vKk07qLjfKS3elvzAvXMBS0ZV3UqNVi2?usp=drive_link). 
